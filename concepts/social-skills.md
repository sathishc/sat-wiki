...
The ability to manage relationships, inspire people, communicate persuasively, and build collaborative networks — the "output layer" of emotional intelligence.

## In Goleman's EQ Model

Fifth domain of [Emotional Intelligence](../concepts/emotional-intelligence.md). Where the other domains are largely internal, social skills are how EQ manifests outward.

### Key Competencies

- **Influence** — using effective persuasion tactics
- **Communication** — sending clear, emotionally attuned messages; listening actively
