...
A navigational map of the strategy and competitive advantage content in this wiki. These frameworks answer the question: *how do organisations win, grow, and avoid being displaced?*

---

## The Core Problem: Why Good Companies Fail

Start here. The most important insight in the strategy cluster:
...
| Framework | Author | Core question | Key concept |
|---|---|---|---|
| [Disruptive Innovation](../concepts/innovators-dilemma.md) | Christensen | Why do good companies get displaced? | Disruptors enter below; incumbents can't respond rationally |
| [RPM Framework](../concepts/innovators-solution.md) | Christensen | Why can't incumbents just copy disruptors? | Resources ≠ capability; Processes and Values resist change |
| [Core Competency](../concepts/core-competency.md) | Prahalad | What is durable competitive advantage? | Hard-to-imitate bundle of skills and technologies |
| [Competing for the Future](../concepts/competing-for-the-future.md) | Prahalad | Why do incumbents miss the future? | They over-focus on defending today's position |
| [System Archetypes](../concepts/system-archetypes.md) | Senge/Meadows | What structural patterns produce incumbent failure? | "Success to the Successful" + "Shifting the Burden" |

### How Entrants Win

| Framework | Author | Core question | Key concept |
|---|---|---|---|
| [Crossing the Chasm](../concepts/crossing-the-chasm.md) | Moore | How do new products reach mainstream markets? | Beachhead segment + Whole Product + pragmatist references |
| [Jobs to Be Done](../concepts/jobs-to-be-done.md) | Christensen | What are customers actually buying? | Customers hire products to do a job; find the unserved job |
...
| Framework | Author | Core question | Key concept |
|---|---|---|---|
| [Amazon Growth Flywheel](../concepts/amazon-growth-flywheel.md) | Bezos | How does Amazon compound advantage? | Reinforcing loop: selection → traffic → lower costs → prices |
| [Compounding](../concepts/compounding.md) | Naval | Why do advantages grow over time? | Long-term games with long-term people |
| [Feedback Loops](../concepts/feedback-loops.md) | Meadows/Senge | What is the structural engine of competitive moats? | Reinforcing loops that self-amplify |
| [Leverage](../concepts/leverage.md) | Naval | What multiplies individual effort? | Labour, capital, code, media |
| [Lindy Effect](../concepts/lindy-effect.md) | Taleb | Which advantages persist? | Survival time predicts future durability |
...
Christensen / Prahalad: strategy should be deliberate — compete for the future you intend. Newport / Christensen: early in a career or product lifecycle, strategy should be emergent — test hypotheses, observe what works. The resolution: be deliberately *open* to emergent signals, then commit deliberately once validated.

**Defending vs. attacking**
Incumbents face a structural disadvantage: their RPM optimises for defending existing positions. Entrants have an advantage: no existing customers to cannibalise. But entrants face the chasm. The [Innovator's Solution](../concepts/innovators-solution.md) is about how incumbents can deliberately create separate units to attack themselves.
