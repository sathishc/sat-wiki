...
## [2026-04-23] ingest | The Start-up of You — Reid Hoffman & Ben Casnocha

Ingested Reid Hoffman and Ben Casnocha's *The Start-up of You* (2012). Applies startup thinking (pivoting, iteration, risk-taking, network effects) to individual career strategy. Core frameworks: permanent beta (you're always evolving), ABZ planning (Plan A/B/Z), competitive advantage (Assets + Aspirations + Market realities), network intelligence (your network is your net worth), weak ties (Granovetter's research made actionable), I^We (individual power through collective networks). Created: sources/hoffman-startup-of-you.md (comprehensive source with all major concepts, frameworks, and cross-references). Created people: reid-hoffman.md (LinkedIn founder, career strategy, network thinking), ben-casnocha.md (co-author, entrepreneur), mark-granovetter.md (sociologist, "Strength of Weak Ties" 1973). Created concepts: permanent-beta.md (continuous adaptation), abz-planning.md (three-plan career strategy), network-intelligence.md (strategic relationship-building), weak-ties.md (acquaintances > close friends for opportunities), i-we.md (I^We multiplicative network effect). Updated: people/naval-ravikant.md (added cross-reference to Hoffman; both emphasize leverage and compounding, but Naval focuses on code/media while Hoffman focuses on networks), concepts/competitive-advantage.md (added Hoffman's individual-level framework: Assets + Aspirations + Market realities). Updated: index.md (new People entries for Hoffman, Casnocha, Granovetter; new "Networks & Relationships" concept section; new source entry). Cross-links throughout to: Naval (leverage, specific knowledge, compounding), Christensen (Jobs to Be Done, pivoting), Taleb (barbell strategy parallels ABZ), Newport (career capital), Porter (competitive advantage), Cialdini (reciprocity principle), systems thinking (networks as systems, feedback loops). 14 files touched (1 source, 3 people, 5 concepts, 2 updates, index, log).
